...
On each matching post, GPIO 16 turns on for 0.5 seconds. Use that GPIO to drive
the MOSFET gate through the appropriate resistor/driver circuit. Do not power a
motor directly from a GPIO pin.
